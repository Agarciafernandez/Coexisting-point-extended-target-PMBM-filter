function [d_gospa, x_to_y_assignment, decomposed_cost] =  GOSPA_point_extended(x_mat, y_mat, p, c, alpha)
...
for ix = 1:nx
    for iy = 1:ny
        ...
        cost_mat(ix, iy) ...
            = min(GaussianWassersteinDistance(x_pos,X,y_pos,Y), c); %Cut-off c_b
